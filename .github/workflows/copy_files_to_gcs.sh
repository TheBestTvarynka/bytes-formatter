...
gsutil -h "Content-Type:text/javascript" -h "Cache-Control:no-store" cp src/selection.js gs://${GCP_BUCKET}
gsutil -h "Content-Type:text/javascript" -h "Cache-Control:no-store" cp src/results.js gs://${GCP_BUCKET}
...
gsutil -h "Content-Type:text/css" -h "Cache-Control:no-store" cp src/results.css gs://${GCP_BUCKET}
